...
namespace Recycle.ViewModels
{
	public class MainViewModel : BaseViewModel
	{
		...
		//PetSinkSetting1.json should be same level folder with Recycle.csproj
		//PetSinkSetting1.json 跟 Recycle.csproj 在相同的資料夾內
		...
		public static class ConfigClass
		{
			...
			public static double local_chartUnit { get; set; } = MaxValue_Chart ;
			
			public static double MaxValue_Height { get; set; } = 1020 ;
